...
#define Release_Customer 0 //客户版本为1 工厂版本为0
...
public:
    ...
    AutoWidthComboBox   *m_TestModecombox;
    ...
    QVector<TrianglePushButton*>  m_triangleBtnlist;
    ...
    void GetUsedStation(const wchar_t *usedstationinfo);

    QStringList m_stusedliststion;
    ...
    void Release_Customer_Init(); //客户工具界面初始化
    QLabel *m_IPlabel;
    QLabel *m_OfflineModelabel;
    QLabel *m_testModelabel;
    QLabel *m_MOlabel;
